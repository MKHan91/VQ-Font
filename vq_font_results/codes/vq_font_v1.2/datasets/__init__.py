...
from .dataset_transformer import CombTrainDataset, CombTestDataset, FixedRefDataset,FixedRefDataset_random
...
def get_fixedref_loader_random(env, env_get, target_dict, ref_unis, cfg, transform, **kwargs):
    dset = FixedRefDataset_random(env,
                           env_get,
                           target_dict,
                           ref_unis,
                           k_shot=cfg.kshot,
